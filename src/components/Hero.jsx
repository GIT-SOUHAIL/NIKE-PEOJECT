...
const Hero = ()=>{
  ...
  return (
    <section
    id="home"
    className=" font-palanquin m8:flex mb-[10rem] py-[10rem]  m8:py-0 " >

     <main
     className="mt-[22rem] m8:mt-[6rem] x6:mt-[24rem] m7:mt-[3rem]  z-[60] m8:w-[45%] ">
      <motion.h2
      ...
      <div className="flex  xl:gap-[2.5rem] m9:gap-[0.5rem] m8:gap-[0rem] gap-[1rem] z-[10] absolute bottom-[-50px] xl:right-[80px]
       l12:right-[85px] lg:right-[47px] l10:right-[50px] m9:right-[22px] m8:right-[15px] x6:right-[70px] m7:right-[140px] x3:scale-[0.6] x3:right-[-53px] x4:right-[-20px] x6:scale-[1.2] m8:scale-[1] ">
      <motion.div
      initial={{opacity : 0 , x:-150}}
      animate={{opacity : 1 , x:0}}
